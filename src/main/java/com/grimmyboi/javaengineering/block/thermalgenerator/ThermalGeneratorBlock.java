...
public class ThermalGeneratorBlock extends Block {
    ...
    private void interactWith(World world, BlockPos pos, PlayerEntity player){
        ...
        if(tileEntity instanceof  ThermalGeneratorTileEntity && player instanceof ServerPlayerEntity){
            ThermalGeneratorTileEntity tg = (ThermalGeneratorTileEntity) tileEntity;
