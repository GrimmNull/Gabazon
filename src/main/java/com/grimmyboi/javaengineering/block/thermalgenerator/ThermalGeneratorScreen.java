...
public class ThermalGeneratorScreen extends ContainerScreen<ThermalGeneratorContainer> {

    private ResourceLocation GUI = new ResourceLocation(Main.MOD_ID, "textures/gui/thermalgenerator_gui.png");
